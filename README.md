...
**A notice takes slot 0.** A scene parked in slot 0 is destroyed by a notice and
does not come back. A scene in any other slot survives -- the notice borrows the
display and the scene returns by itself. Keep your scenes off slot 0, which the
examples do, and this never comes up. (Measured 2026-08-14; this file previously
said a notice emptied whatever slot you used, which was slot 0 alone being
tested.)
